...
export class LoginComponent implements OnInit {
  ...
  public changePassword() {
    ...
    this.httpClient
      .post(
        'http://0.0.0.0:5000/changepassword',
        {
  ...
  */
  ...
  public login() {
    ...
    this.loginNewUser
      .loginUser(this.newUser.userName, this.newUser.passWord)
      .subscribe(
        x => {
          // log the response
          console.log(x);
  ...
  */
  ...
  public getPatientInfo() {
    ...
    this.httpClient
      ...
      .subscribe(
        info => {
          interface GivenPatient {
            address?: string;
            patient_id?: number;
            email?: string;
          }
          const sendObject: GivenPatient = info;

          console.log(sendObject.address);
          console.log(sendObject.email);
        },
        err => {
